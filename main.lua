...
-- Declare virtual window size. This is the screen size the 
-- game will be rendered with.
VIRTUAL_WIDTH = 432
VIRTUAL_HEIGHT = 243
...
function love.load()
    ...
    smallFont = love.graphics.newFont('retro_gaming/Retro Gaming.ttf', 8)
    medFont = love.graphics.newFont('retro_gaming/Retro Gaming.ttf', 16)
    bigFont = love.graphics.newFont('retro_gaming/Retro Gaming.ttf', 32)
